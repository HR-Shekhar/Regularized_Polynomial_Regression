...
st.markdown("Compare predictions(used graph for better visualization) from a manually built regularized polynomial regression model and a scikit-learn model.")
